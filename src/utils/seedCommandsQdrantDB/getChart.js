...
const text = process.env.FETCH_CHART_TEXT;
    ...
    points: [

        {
            ...
            payload: {
                ...
                command_name: "chart_liquidity",
                    
                systemPrompt: process.env.FETCH_CHART_PROMPT
            }
        }
    ]
...
console.log("Seeded get chart command into Qdrant DB.");