...
const text = process.env.MANAGE_POSITION_TEXT;
    ...
    points: [

        {
            ...
            payload: {
                ...
                command_name: "manage_position",
                    
                systemPrompt: process.env.MANAGE_POSITION_PROMPT
            }
        }
    ]
...
console.log("Seeded manage position command into Qdrant DB.");