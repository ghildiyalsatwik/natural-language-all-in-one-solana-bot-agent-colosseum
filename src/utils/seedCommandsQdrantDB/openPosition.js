...
const text = process.env.OPEN_POSITION_TEXT;
    ...
    points: [

        {
            ...
            payload: {
                ...
                command_name: "add_liquidity",
                    
                systemPrompt: process.env.OPEN_POSITION_PROMPT
            }
        }
    ]
...
console.log("Seeded open position command into Qdrant DB.");